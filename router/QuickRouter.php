...
use Router\Quick\DataGenerator\GroupCountBased as RouteGenerator;
use Router\Quick\Dispatcher\GroupCountBased as Dispatcher;
use Router\Quick\RouteCollector;
use Router\Quick\RouteParser\Std as RouteParser;

use Zend\Expressive\Exception;

use Psr\Http\Message\ServerRequestInterface as Request;
use Router\BaseRouter\Exception\InvalidArgumentException;
use Router\BaseRouter\RouteResult;
use Router\BaseRouter\Route;
use Router\BaseRouter\RouterInterface;

class QuickRouter implements RouterInterface
{
    /**
     ...
     * @return \Router\BaseRouter\RouteResult
     */
     ...
     * @throws \Router\BaseRouter\Exception\InvalidArgumentException if the route name is not
     *     known.
     */
